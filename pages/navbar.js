...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<div class="container px-5">
		<a class="navbar-brand" href="#page-top">
			<img src="resources/images/logo/logo-32.png" alt="" width="32" height="32" class="d-inline-block align-text-top">
			Wildlife token
		</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link" href="tokens-distribution.html">Tokens</a></li>
				<li class="nav-item"><a class="nav-link" href="#">Whitepapers</a></li>
<!--
